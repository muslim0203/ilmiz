...
def _privacy_page() -> PageMeta:
    ...
    body = (
        ...
        "saqlanmaydi. Veb-server odatiy texnik jurnal yuritadi — u nosozliklarni aniqlash, "
        "suiiste’molning oldini olish va umumlashtirilgan tashrif statistikasini tuzish uchun "
        "kerak. Statistika faqat administratorga ko‘rinadi va alohida shaxsga bog‘lanmaydi.</p>"
